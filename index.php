...
<html lang="en">
    <head>
        ...
        <title>iSAR! - your one-stop place to know your wireless devices' SAR levels</title>
        ...
        <div id="body">
            <div id="upper-body">
                ...
                <div id="img-area" class="i-pos theme-default">
                    <div id="img-box">
                        <div>
                            <!--Nivo Slider images goes here -->
                            <div id="slider" class="nivoSlider">
                                <div>
                                    <img class="img-pos img-border" alt="img-1" src="./static/img/nivo/3women-smartphone.jpg" height="380" width="780">
                                </div>
                                <div>
                                    <img class="img-pos img-border" alt="img-2" height="380" width="780" src="./static/img/nivo/bilde.jpeg">
                                </div>
                                <div>
                                    <img class="img-pos img-border" alt="img-3" height="380" width="780" src="./static/img/nivo/sam-tab.jpg">
                                </div>
                                <div>
                                    <img class="img-pos img-border" alt="img-4" height="380" width="780"  data-transition="slideInRight" src="./static/img/nivo/smart.jpg">
                                </div>
                                <div>
                                    <img class="img-pos img-border" alt="img-5" height="380" width="780" src="./static/img/nivo/smart-phones1.jpg">
                                </div>
                                <div>
                                    <img class="img-pos img-border" alt="img-6" height="380" width="780" data-transition="slideInLeft" src="./static/img/nivo/zte.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="nav-area" class="i-pos">
                    ...
                    <div id="direct" class="nav">
                        <div>
                            <a href="./sar/direct.php" title="Click to browse SAR database!!!" target="_self">
                                <span>
                                    browse SAR database&raquo;
                                </span>
                            </a>
                        </div>
                    </div>
